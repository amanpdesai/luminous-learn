...
export default function AuthPage() {
  ...
  useEffect(() => {
    ...
    if (activeTab !== "login") url.searchParams.set("tab", activeTab)
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    const confirmPassword = (document.getElementById("confirm-password-signup") as HTMLInputElement).value
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center relative bg-background px-4 py-8 overflow-hidden">
      {/* Background */}
      ...
      <div className="absolute top-6 left-6 z-10">
        <Button
          variant="ghost"
          size="sm"
          className="glow-button flex items-center gap-1 text-muted-foreground hover:text-foreground"
          onClick={() => router.push("/")}
        >
      ...
      {showSignupPopup && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="bg-card p-6 rounded-xl shadow-xl border border-border/50 max-w-sm w-full text-center space-y-4 animate-in fade-in duration-300">
            <h2 className="text-xl font-semibold glow-text">Confirmation Email Sent</h2>
            <p className="text-sm text-muted-foreground">Please check your inbox to verify your account.</p>
            <Button className="w-full glow-button" onClick={() => setShowSignupPopup(false)}>OK</Button>
          </div>
        </div>
      )}
      ...
      <div className="w-full max-w-md z-10">
        <Card className="w-full border-border/50 glow-border backdrop-blur-sm bg-card/80">
              ...
              <Tabs defaultValue={activeTab} value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="signup" className="space-y-4 animate-in fade-in-50 duration-300">
                  <form onSubmit={handleSignup} className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="confirm-password-signup" className="text-sm">
                        Re-enter Password
                      </Label>
                      <div className="relative">
                        <Input
